...
const AdminSubCategoryLessonCreatePage = () => {
  ...
  const debouncedSubmit = useDebouncedCallback( async (data: AddCategoryLessonSchema) => {
    ...
    if(imageBase64 && imageBase64 !== ''){
      ...
      payload = {...payload, media: res.data.path, category_lesson_id: parent_id}
    }
...
export default AdminSubCategoryLessonCreatePage;